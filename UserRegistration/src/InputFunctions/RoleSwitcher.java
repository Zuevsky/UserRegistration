...
public class RoleSwitcher {
    ...
    public ArrayList<String> roleConstructor() {
        ...
        System.out.println("\nДля выбора доступны роли 3-ех уровней. По одной роли с 1 и 2 уровня, ЛИБО одна роль 3-го уровня.");
    ...
    private String switchRoleLvl2() {
        ...
        do {
            ...
            switch (choice) {
                ...
                case "3" -> role2Lvl = NEXT;
                default -> {
                    role2Lvl = ERROR;
                    System.out.println("Выберите вариант из предложенного списка.");
                }
            }
        } while(role2Lvl.equals(ERROR));
        return role2Lvl;
    }
